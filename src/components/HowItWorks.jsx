    ...
    <section className='common-padding'>
        <div className="screen-max-width">
            ...
            <div className="flex flex-col items-center">
                ...
                <p className="hiw-subtitle">It's here the biggest in the history of apple GPUs.</p>
            </div>
            ...
            <div className="mt-10 md:mt-20 mb-14">
                <div className="relative h-full flex-center">
                    ...
                    <img 
                        src={frameImg}
                        alt="frame"
                        className="bg-transparent relative z-5"
                    />
                    </div>
            ...
            <div className="hiw-text-container px-10 md:px-32 flex-center">
